    ...
    options (configuration) {
      let options =  minimist(process.argv.slice(2), {
        ...
        default: {
          ...
          maxListeners: process.env.NODE_MAX_LISTENERS || configuration.setup.maxListeners || 10,
      ...
      configuration.setup.executablePath = process.env.NODE_EXECUTABLE_PATH || path.resolve(configuration.setup.executablePath)
