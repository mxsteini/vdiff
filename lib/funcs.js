...
module.exports = (options, configuration) => {
  return {
    ...
    async processTarget (browser, browserName, sequenceName, workDir, processTargets, testName, test) {
      const page = []
      ...
      better.info('starting Tests: ' + browserName + ' ' + sequenceName + ' ' + testName + ' steps: ' + test.steps.length)
